...
function readTemplateFile($templateName){
	...
	try{
		...
		$myfile 		= fopen(__DIR__.'/../../../email_templates/' . $templateName . ".html", "r") or die("Unable to open file!");
		$templateString =  fread($myfile,filesize(__DIR__.'/../../../email_templates/' . $templateName . ".html"));
