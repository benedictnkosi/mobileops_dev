...
<form class="idealforms" novalidate action="index.php?register"
	method="post"><!-- Text -->
...
<div class="row uniform">
<div class="6u 12u(3)">
<div class="field"><input type="text" name="register" value="client"
	style="display: none;" /> <input type="text" name="firstname" id="firstname"
	value="" placeholder="First Name" /> <span class="error"></span></div>
</div>
<div class="6u 12u(3)">
...
<div class="field"><input type="password" name="password" id="password"
	value="" placeholder="Password" /> <span class="error"></span></div>
</div>
<div class="6u 12u(3)">
<div class="field"><input type="password" name="confirm_password"
	id="confirm_password" value="" placeholder="Confirm Password" /> <span
	class="error"></span></div>
</div>
</div>
