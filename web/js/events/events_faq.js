...
function getFaq(){
	$.ajax({
		type : 'GET',
		url : 'src/AppBundle/Controller/controller_faq.php',
		data : 'getFaq=all',
		dataType : "json",
		...
		$.getScript( "web/js/jquery-2.1.1.js", function( data, textStatus, jqxhr ) {
		});
		
		$.getScript( "web/js/jquery.mobile.custom.min.js", function( data, textStatus, jqxhr ) {
		});
		
		$.getScript( "web/js/main.js", function( data, textStatus, jqxhr ) {
		});
	},
	});
}
