...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'mobilrop_mobileops', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bd73556e3aa11600680ff56e8cefc6bd443af26f6644f99c3f7a001800f42e1a');
    ...
    {
        return $this->services['monolog.handler.syslog'] = new \Monolog\Handler\StreamHandler('/var/log/symfony.log', 400, true, NULL);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8d9d166c23a0a0a0775c8f102ab9adf1f672954d');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57320af9808979.45054303')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'mobilrop_mobileops',
            'database_user' => 'root',
            'database_password' => '',
            ...
            'secret' => '8d9d166c23a0a0a0775c8f102ab9adf1f672954d',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '8d9d166c23a0a0a0775c8f102ab9adf1f672954d',
